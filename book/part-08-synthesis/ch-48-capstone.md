...
**邊界與拓樸層**([Ch 16–24](../part-04-architecture/ch-18-ddd-strategic-tactical.md)):DDD / Event Storming / C4 / Modular Monolith / EDA / Cell-based,全部都是「邊界在哪裡、誰擁有它」這件事的不同 zoom level。
