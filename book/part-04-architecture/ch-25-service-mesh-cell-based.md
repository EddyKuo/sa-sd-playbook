...
> **下游章節**:[Ch 27 Security by Design](../part-05-quality/ch-27-security-by-design.md)、[Ch 30 可觀測性](../part-05-quality/ch-29-observability-otel.md)
...
四項中先挑一項做完就好,建議從最後那一項 ⸺ 把現在系統的三層各填上目前的工具與分數,**寫不出分數的那一層就是還沒想清楚的那一層**。本書 Ch 27 會把 Security by Design 接在這層治理之上(認證、加密、政策強制要落到哪一層);Ch 30 會把可觀測性的訊號流穿過這三層,告訴你哪些 metrics 該在 Gateway 收、哪些該在 Mesh 收、哪些該跨 cell 聚合。
...
- **可觀測性接續**:[Ch 30 可觀測性](../part-05-quality/ch-29-observability-otel.md) ⸺ Gateway / Mesh / Cell 三層的訊號該怎麼聚合
