...
# 第 22 章|事件驅動架構、CQRS 與 Event Sourcing
## ⸺ 三件不該綁一起的工具

> **前置閱讀**:[Ch 17 DDD 戰略與戰術](./ch-17-ddd-strategic-tactical.md)、[Ch 18 Event Storming 與 Event Modeling](./ch-18-event-storming-modeling.md)、[Ch 21 微服務拆分判準](./ch-21-microservices.md)
> **下游章節**:[Ch 23 API Gateway 與 BFF](./ch-24-service-mesh-cell-based.md)、[Ch 28 可觀測性](../part-05-quality/ch-26-observability-otel.md)、[Ch 36 Multi-Agent 系統設計](../part-07-ai-era/ch-36-multi-agent.md)
...
- **下一章**:[Ch 23 API Gateway 與 BFF](./ch-24-service-mesh-cell-based.md) ⸺ 同步邊界與事件邊界的協作
- **事件視角承接**:[Ch 18 Event Storming 與 Event Modeling](./ch-18-event-storming-modeling.md) ⸺ 從便利貼到事件流的對齊
- **戰術 DDD**:[Ch 17 DDD 戰略與戰術設計](./ch-17-ddd-strategic-tactical.md) ⸺ Aggregate / Bounded Context 是 EDA 的拆分基礎
- **微服務拆分**:[Ch 21 微服務拆分判準](./ch-21-microservices.md) ⸺ EDA 是拆分後的協作介面
- **可觀測性**:[Ch 28 可觀測性](../part-05-quality/ch-26-observability-otel.md) ⸺ 事件流的 trace / lineage / OpenLineage 整合
- **延伸補章**:[補章 D 共識/狀態/衝突](../part-07-ai-era/chD-multi-agent.md) ⸺ Multi-Agent 場景的事件流挑戰
...
[^CIT-227]: Confluent Schema Registry Documentation (docs.confluent.io/platform/current/schema-registry/)。Schema 演化與相容策略。同 Ch 18 CIT-186。
[^CIT-228]: AsyncAPI Specification v3.0 (asyncapi.com, 2024)。事件式 API 規範,2026 年事實標準。同 Ch 18 CIT-184。
