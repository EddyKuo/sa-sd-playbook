...
> **下游章節**:[Ch 20 C4 模型](./ch-20-c4-model-visualization.md)、[Ch 23 Event-Driven 與事件溯源](./ch-23-event-driven-cqrs-es.md)、[Ch 39 Multi-Agent 系統設計](../part-07-ai-era/ch-39-multi-agent.md)
> **延伸補章**:[Ch 40 共識/狀態/衝突](../part-07-ai-era/ch-40-multi-agent.md)
...
### 18.2.4 與 BPMN(Ch 9)、DDD(Ch 18)、Event Sourcing(Ch 23)的關係
...
- **Multi-Agent 系統**:[Ch 39 Multi-Agent 系統設計](../part-07-ai-era/ch-39-multi-agent.md) ⸺ 事件流在 Agent 協作中的角色
- **延伸補章**:[Ch 40 共識/狀態/衝突](../part-07-ai-era/ch-40-multi-agent.md)
