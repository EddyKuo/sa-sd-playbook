...
# 第 18 章|Event Storming 與 Event Modeling
## ⸺ 從便利貼到事件流的對齊工具

> **前置閱讀**:[Ch 9 流程模型](../part-02-analysis/ch-09-process-modeling.md)、[Ch 17 DDD 戰術設計](./ch-17-ddd-strategic-tactical.md)
> **下游章節**:[Ch 19 C4 模型](./ch-19-c4-model-visualization.md)、[Ch 22 Event-Driven 與事件溯源](./ch-22-event-driven-cqrs-es.md)、[Ch 36 Multi-Agent 系統設計](../part-07-ai-era/ch-36-multi-agent.md)
> **延伸補章**:[補章 D 共識/狀態/衝突](../part-07-ai-era/chD-multi-agent.md)

---

## 18.1 冷觀察 ⸺ 380 張便利貼、兩個月、零個 service
...
### 18.2.3 Event Modeling 補的是「便利貼到 spec」那段
...
### 18.2.4 與 BPMN(Ch 9)、DDD(Ch 17)、Event Sourcing(Ch 22)的關係
...
| **Ch 18** | **Event Storming / Event Modeling** | **探索期 → spec 對接,給 RD 吃** |
| [Ch 17](./ch-17-ddd-strategic-tactical.md) | Bounded Context / Aggregate | 戰術設計,Event Storming 的 output 之一 |
| [Ch 22](./ch-22-event-driven-cqrs-es.md) | Event Sourcing / CQRS | 落地實作,Event Modeling 的 runtime |

把這條軸看完就會發現,Event Storming 不是孤立的工作坊技藝,**它是從「業務直覺」到「事件流實作」這條軌道上的第一站**。停在 Big Picture 不走下去,就像火車進站後忘了開車。

---

## 18.3 決策框架 ⸺ 這次該開哪一層工作坊

### 18.3.1 七種便利貼的角色與顏色約定
...
### 18.3.4 一張決策樹:Event Storming 該停在哪一層
...
### 18.3.5 線上 / 遠端 Event Storming 的工具
...
### 18.3.6 2026 視角:Event Modeling × AsyncAPI × AI Agent
...
## 18.5 交付清單 ⸺ 一頁式 Event Storming Outcome Card
...
四項中先挑一項做完就好,建議是最後那一項 ⸺ 把上一場 Event Storming 的牆翻出來,補一張 outcome card,逼自己回答「下一層什麼時候開」,再往下讀 [Ch 19 C4 模型](./ch-19-c4-model-visualization.md)。本章留給你的就是「便利貼怎麼變 spec」那條鏈。

---

## Cross-References

- **下一章**:[Ch 19 C4 模型與架構視覺化](./ch-19-c4-model-visualization.md) ⸺ 從事件流到容器級拓樸
- **戰術 DDD**:[Ch 17 DDD 戰術設計](./ch-17-ddd-strategic-tactical.md) ⸺ Event Storming 的 Aggregate / Bounded Context 上接點
- **流程模型**:[Ch 9 BPMN / 狀態機 / 決策表](../part-02-analysis/ch-09-process-modeling.md) ⸺ 沉澱期的對照工具
- **事件溯源實作**:[Ch 22 Event-Driven 與事件溯源](./ch-22-event-driven-cqrs-es.md) ⸺ Event Modeling 的 runtime
- **Multi-Agent 系統**:[Ch 36 Multi-Agent 系統設計](../part-07-ai-era/ch-36-multi-agent.md) ⸺ 事件流在 Agent 協作中的角色
- **延伸補章**:[補章 D 共識/狀態/衝突](../part-07-ai-era/chD-multi-agent.md)
