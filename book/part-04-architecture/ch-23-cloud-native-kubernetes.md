...
## 23.1 冷觀察 ⸺ 12 個工程師、Kubernetes 1.30、SRE 工時 8% → 35%
...
## 23.3 決策框架 ⸺ 部署平台選擇、K8s 採用四維、GitOps 節奏
...
### 23.3.6 程式碼長相:一份 12-Factor 對齊的 Deployment + Service
...
## 23.5 交付清單 ⸺ 一頁式 Cloud-Native Choice Card
