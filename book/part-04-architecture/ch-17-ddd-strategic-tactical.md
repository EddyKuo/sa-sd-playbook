...
## 17.1 冷觀察 ⸺ 三個系統共用一個 `patient`,出院當天對不上
...
## 17.2 真問題 ⸺ DDD 的價值在語言邊界,不在 Aggregate 拆分
...
### 17.2.3 Ubiquitous Language 不是字典,是契約
...
## 17.5 交付清單 ⸺ 一頁式 Bounded Context Card
...
| 上游 Context | 整合模式(§17.3.2 八選一) | 整合協議 | Owner Team |
|---|---|---|---|
