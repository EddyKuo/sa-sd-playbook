...
| pgvector | PG 向量 extension,RAG 推薦 | Ch 15、[Ch 39](part-07-ai-era/ch-39-rag-memory-tool.md)、[Ch 28](part-05-quality/ch-28-compliance.md) |
...
| LangSmith / Langfuse / Phoenix | AI Agent observability | Ch 29、[Ch 37](part-07-ai-era/ch-37-ai-native-architecture.md)、[Ch 45](part-07-ai-era/ch-45-ai-eval-drift-redteam.md) |
...
| Anthropic Skills + Subagents | CDE 三層 | [Ch 38](part-07-ai-era/ch-38-context-driven-engineering.md)、[Ch 40](part-07-ai-era/ch-40-multi-agent.md) |
...
| Cohere Rerank v3 | RAG reranking | [Ch 39](part-07-ai-era/ch-39-rag-memory-tool.md) |
| RAGAS / TruLens / DeepEval | RAG / LLM eval | Ch 44、[Ch 46](part-07-ai-era/ch-46-agentic-qa.md) |
...
| 工具 | 角色 | 出現章節 |
|---|---|---|
| Cursor | IDE-based Agent | [Ch 38](part-07-ai-era/ch-38-context-driven-engineering.md)、[Ch 44](part-07-ai-era/ch-44-coding-agent.md) |
| Anthropic Claude Code | Terminal Agent + Skills + Subagents | Ch 37、Ch 43、[Ch 47](part-07-ai-era/ch-47-legacy-ai.md) |
