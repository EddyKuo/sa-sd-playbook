...
> **下游章節**:[Ch 3 利害關係人與需求工程](./ch-03-project-initiation.md)、[Ch 11 設計總則](../part-03-design/ch-11-architecture-principles.md)、[Ch 34 Context-Driven Engineering](../part-07-ai-era/ch-34-context-driven-engineering.md)
> **延伸補章**:無
...
問題不是 ShelfMart 沒做事,是**他們的決策節奏與市場節奏對不上**。
...
ShelfMart 的瀑布並沒有「執行不力」。每個階段都做了、每個交付都簽了、每張圖都畫了。他們在做的,是**用一個 1990 年代節奏的開發方法,去回應一個 2025 年節奏的市場**。

換句話說,真正在處理的問題不是「該選哪種方法論」,而是 ⸺

> 「讓開發系統的決定性節奏(Decision Tempo),跟業務需要回應市場的節奏(Business Tempo),對齊。」
...
| 2026 | Context-Driven Engineering(CDE)| 連續 | 連續 | AI 協作下,「決定的可被傳遞」變成核心瓶頸 |
...
> ✅ **修正方向**:DORA 四指標 + SPACE Framework 並行追蹤(Ch 29 詳述)。任何工具導入前,先問「這個工具會改變哪兩個團隊的協作方式」⸺ 沒答案就不裝。
...
- **AI 時代 CDE 完整展開**:[Ch 34 Context-Driven Engineering](../part-07-ai-era/ch-34-context-driven-engineering.md)
