...
> **下游章節**:[Ch 21 微服務拆分](../part-04-architecture/ch-21-microservices.md)、[Ch 22 Event-Driven 架構](../part-04-architecture/ch-22-event-driven-cqrs-es.md)、[Ch 33 AI Agent 友善架構](../part-07-ai-era/ch-33-ai-native-architecture.md)
> **延伸補章**:無
...
- **微服務拆分後的 API 邊界**:[Ch 21 微服務拆分](../part-04-architecture/ch-21-microservices.md)
- **Webhook 與 AsyncAPI 在事件架構的位置**:[Ch 22 Event-Driven 架構](../part-04-architecture/ch-22-event-driven-cqrs-es.md)
- **AI Agent 友善 API 在 AI-Native 架構的角色**:[Ch 33 AI Agent 友善架構](../part-07-ai-era/ch-33-ai-native-architecture.md)
