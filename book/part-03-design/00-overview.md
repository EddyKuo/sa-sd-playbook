...
- **長距離影響**:[Ch 34 Fitness Functions](../part-06-engineering/ch-34-fitness-functions.md)(Ch 11 的架構原則變成可執行測試)、[Ch 37 CDE](../part-07-ai-era/ch-37-context-driven-engineering.md)(Ch 17 的 CUX 設計在 AI 工程時代的延伸)
