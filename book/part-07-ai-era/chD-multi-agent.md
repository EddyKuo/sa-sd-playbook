...
### D.3.1 解法 1:重建「中央但不單點」的共識層 — Event Log as Truth
...
### D.3.2 解法 1 強化版:兩階段共識(2-Phase Agreement)
...
### D.3.3 解法 2:衝突解決協議(Bounded Negotiation)
...
### D.3.4 解法 3:分散式狀態機(Distributed State Machine)
