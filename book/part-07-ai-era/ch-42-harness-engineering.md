...
### I.2.1 Scaffolding 與 Harness 的分界
...
## I.3 決策框架 ⸺ Harness 五大組件、兩條光譜、SA 的交付物

把 Harness 拆細，現場可以用的劃法是五個組件、兩條光譜、一份交付清單。

### I.3.1 Harness 五大組件與各自的失敗模式
...
### I.3.2 第一條光譜：Minimal vs. Heavy Orchestration
...
### I.4.3 可帶走 Artifact ⸺ Harness 規格五份契約清單
