...
chapter: B
part: VII
title: 補章 B|Agentic QA — 非確定性系統的品質保證
slug: agentic-qa
agent: QA
skills_used:
  - qa/strategy-bdd
...
# 補章 B|Agentic QA ⸺ 非確定性系統的品質保證
## ⸺ Quality Assurance for Non-Deterministic Systems

> **插入位置**:緊接 [Ch 38 AI 系統的 Eval / Drift / Red Team](./ch-38-ai-eval-drift-redteam.md) 之後
> **前置閱讀**:[Ch 27 SRE / SLO / Chaos](../part-05-quality/ch-27-sre-slo-chaos.md)、[Ch 33 AI-Native](./ch-33-ai-native-architecture.md)、[Ch 38](./ch-38-ai-eval-drift-redteam.md)
> **強連結補章**:[補章 E Compliance](../part-05-quality/chE-compliance.md)、[補章 D Multi-Agent](./chD-multi-agent.md)

---

## B.1 冷觀察 ⸺「LGTM」不能再是一個動詞
...
## B.2 真問題 ⸺ 把 QA 重新分類:確定性層 vs 非確定性層

混亂的根源是把所有測試都丟在一起。比較乾淨的解法是把 Agent 系統切成兩層:

### B.2.1 確定性層(Deterministic Layer)
...
### B.2.2 非確定性層(Non-Deterministic Layer)
...
## B.3 決策框架 ⸺ Eval Set、LLM-as-Judge、Red Team、Drift 四件齊備

### B.3.1 Eval Set 的建立與治理
...
### B.3.4 Behavior Drift:沒人改 prompt,但行為變了
...
- **前置**:[Ch 27 SRE](../part-05-quality/ch-27-sre-slo-chaos.md)、[Ch 33 AI-Native](./ch-33-ai-native-architecture.md)、[Ch 38 AI Eval](./ch-38-ai-eval-drift-redteam.md)
- **強連結補章**:[補章 E Compliance](../part-05-quality/chE-compliance.md)、[補章 D Multi-Agent](./chD-multi-agent.md)
