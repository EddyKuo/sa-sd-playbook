...
> **延伸補章**:[Ch 28 Compliance](../part-05-quality/ch-28-compliance.md)、[Ch 40 Multi-Agent](./ch-40-multi-agent-consensus.md)

---

## 45.1 冷觀察 ⸺「LGTM」不能再是一個動詞
...
## 45.2 真問題 ⸺ 把 QA 重新分類:確定性層 vs 非確定性層
...
## 45.3 決策框架 ⸺ Eval Set、LLM-as-Judge、Red Team、Drift 四件齊備

### 45.3.1 Eval Set 的建立與治理
...
### 45.3.4 Behavior Drift:沒人改 prompt,但行為變了
