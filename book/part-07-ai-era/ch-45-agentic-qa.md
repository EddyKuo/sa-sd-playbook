...
chapter: 45
part: VII
title: Ch 45|Agentic QA — 非確定性系統的品質保證
slug: agentic-qa
agent: QA
skills_used:
  - qa/strategy-bdd
...
> **插入位置**:緊接 [Ch 44 AI 系統的 Eval / Drift / Red Team](./ch-44-ai-eval-drift-redteam.md) 之後
> **前置閱讀**:[Ch 30 SRE / SLO / Chaos](../part-05-quality/ch-30-sre-slo-chaos.md)、[Ch 36 AI-Native](./ch-36-ai-native-architecture.md)、[Ch 44](./ch-44-ai-eval-drift-redteam.md)
> **延伸補章**:[Ch 28 Compliance](../part-05-quality/ch-28-compliance.md)、[Ch 40 Multi-Agent](./ch-40-multi-agent.md)
...
- **前置**:[Ch 30 SRE](../part-05-quality/ch-30-sre-slo-chaos.md)、[Ch 36 AI-Native](./ch-36-ai-native-architecture.md)、[Ch 44 AI Eval](./ch-44-ai-eval-drift-redteam.md)
- **延伸補章**:[Ch 28 Compliance](../part-05-quality/ch-28-compliance.md)、[Ch 40 Multi-Agent](./ch-40-multi-agent.md)
