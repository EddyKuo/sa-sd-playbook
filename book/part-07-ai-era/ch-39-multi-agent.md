...
- **回顧**:[Ch 36 AI-Native 架構](./ch-36-ai-native-architecture.md) ⸺ L5 Agent Orchestration 是本章展開的母層
- **回顧**:[Ch 37 Context-Driven Engineering](./ch-37-context-driven-engineering.md) ⸺ Role 是本章 Multi-Agent 在 design-time 的契約
