...
## 41.2 真問題 ⸺ Agent 設定語言要解決什麼分析問題？

### 41.2.1 四個分析問題，都需要文件化
...
### 41.3.2 最重要的架構選擇：[Manager Pattern](../annex-f-glossary.md#manager-pattern) vs. [Handoff Pattern](../annex-f-glossary.md#handoff-pattern)
...
### 41.3.3 [Progressive Disclosure](../annex-f-glossary.md#progressive-disclosure)：三層載入策略
...
### 41.3.4 CLAUDE.md / 專案記憶：跨 Agent 的全域規格
...
### 41.3.5 SKILL.md 開放標準：跨平台的可重用能力
