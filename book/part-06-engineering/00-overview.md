...
- **AI 工程師(讀 VII 篇前)**:Ch 33 的 ADR 格式直接對應 [Ch 38 CDE](../part-07-ai-era/ch-38-context-driven-engineering.md) 的 CLAUDE.md 設計;Ch 34 的 Fitness Function 是 [Ch 46 Agentic QA](../part-07-ai-era/ch-46-agentic-qa.md) 的前置概念。
...
- **長距離影響**:[Ch 38 CDE](../part-07-ai-era/ch-38-context-driven-engineering.md)(Ch 33 ADR 的格式直接演化成 AI 時代的 CLAUDE.md / agents.md)、[Ch 46 Agentic QA](../part-07-ai-era/ch-46-agentic-qa.md)(Ch 34 Fitness Functions 是 Agentic QA 的人工驗證替代品設計起點)
