...
## 29.1 冷觀察 ⸺ 17 個內部工具、0 人 onboarding、Bash 比 IDP 快
...
## 29.2 真問題 ⸺ Platform-as-a-Product,不是 DevOps 改名
...
### 29.2.1 Team Topologies 不是組織架構圖,是流動圖
...
### 29.2.2 Platform-as-a-Product:內部開發者是客戶
...
### 29.2.3 IDP 的組成不是工具清單,是「最少摩擦的服務目錄」
...
### 29.2.4 2026 視角:Agent 進 IDP 之後,問題不是「介面換成對話」
...
## 29.3 決策框架 ⸺ Team Topologies、Platform-as-a-Product、DORA + SPACE、IDP 工具取捨

下面這幾張表跟兩張 Mermaid,在現場相當好用。前提是先回答一件事:**你的組織現在的 cognitive load 是不是真的需要 platform 收斂**。這個問題搞清楚,後面才有意義。

### 29.3.1 Team Topologies 四類團隊對照表
...
### 29.3.2 Platform-as-a-Product 五要素
...
### 29.3.3 Golden Path / Paved Road 設計原則
...
### 29.3.5 決策樹:現在該不該成立 Platform team
...
### 29.3.6 IDP 工具取捨:Backstage / Port / Cortex
...
### 29.3.7 程式碼長相:Backstage Service Catalog YAML
...
## 29.5 交付清單 ⸺ 一頁式 Platform Product Card
