...
## 31.1 冷觀察 ⸺ ADR 寫了 Hexagonal,18 個月後依賴方向反向 73%
...
那場會議裡負責這份 ADR 的 staff engineer 沒答上來這 11 個月之間有誰知道、誰簽過、誰退過 PR。實際上不是沒人知道 ⸺ 是 CI 從來沒擋過。`./mvnw test` 永遠綠燈,SonarQube 永遠 A 級,因為**沒有任何一條測試在驗證「依賴方向」這件事**。
...
### 31.2.2 Evolutionary Architecture 不是「自然會演進」
...
## 31.3 決策框架 ⸺ Fitness Function 五層 × 三維分類

### 31.3.1 五層 Fitness Function 全景圖
...
### 31.3.4 「這條 ADR 該寫哪一層 Fitness Function」決策樹
...
## 31.5 交付清單 ⸺ 一頁式 Fitness Function Card
