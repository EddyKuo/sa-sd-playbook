...
| **HL7 v2.5.1 ADT + FHIR R4** | 醫療資訊整合 | [Ch 8](part-02-analysis/ch-08-data-modeling-normalization.md)、[Ch 13](part-03-design/ch-13-architecture-styles.md)、[Ch 36](part-07-ai-era/ch-36-ai-native-architecture.md) |
...
| **OWASP Top 10**(Web 2021、API 2023、LLM 2024 / 2025)| Web / API / LLM 安全 | Ch 27、[Ch 44](part-07-ai-era/ch-44-ai-eval-drift-redteam.md) |
...
| **EU AI Act**(2024,Annex III 高風險系統 2026/8/2 全面執行)| AI 系統合規 | [Ch 36](part-07-ai-era/ch-36-ai-native-architecture.md)、Ch 28 |
...
| 標準 / 模式 | 範疇 | 出現章節 |
|---|---|---|
| **Strangler Fig Pattern**(Martin Fowler 2004)| 漸進遷移策略 | [Ch 21](part-04-architecture/ch-21-modular-monolith.md)、[Ch 46](part-07-ai-era/ch-46-legacy-ai.md) |
