...
> **前置閱讀**：[Ch 40 AI 能力地圖](./ch-40-ai-capability-map.md)、[Ch 38 AI Eval / Drift / Red Team](../part-07-ai-era/ch-38-ai-eval-drift-redteam.md)
> **下游章節**：[Ch 44 AI 程式碼的審計哲學](./ch-44-ai-code-audit.md)
> **延伸補章**：[補章 B Agentic QA](../part-07-ai-era/chB-agentic-qa.md)、[補章 G 工程直覺保護手冊](./chG-engineering-intuition.md)

---

## 43.1 冷觀察 ⸺ 六個月連續通過，第七個月資料外洩
...
## 43.2 真問題 ⸺ AI 的威脅知識有截止日，你的威脅環境沒有
...
**第二個認知**：AI 的「沒有發現問題」不等於「沒有問題」。這和 Ch 42 討論的判斷邊界一致，但在安全領域後果特別嚴重——因為安全漏洞的代價往往是不可逆的。
...
3. 記錄每個案例的 AI 輸出，與人工判斷對比
4. 彙整成 Failure Catalog 條目，更新委派邊界
```
...
glossary:
  - anchor: indirect-prompt-injection
    ...
    body: |
      ...
      AI 的輸入介面。見 Ch 43.1，ClearVault 案例。
