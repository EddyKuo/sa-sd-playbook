...
> **下游章節**:[Ch 10 NFR 與品質情境](./ch-10-spec-documents.md)、[Ch 23 Event-Driven 與事件溯源](../part-04-architecture/ch-23-event-driven-cqrs-es.md)、[Ch 39 Multi-Agent 系統設計](../part-07-ai-era/ch-39-multi-agent.md)
...
- **多 Agent 協作流程**:[Ch 39 Multi-Agent 系統設計](../part-07-ai-era/ch-39-multi-agent.md)
- **Multi-Agent 共識與衝突**:[Ch 40](../part-07-ai-era/ch-40-multi-agent.md) ⸺ Agent 之間的流程編排與狀態同步
