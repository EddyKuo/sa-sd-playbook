...
> **下游章節**:[Ch 8 資料建模](./ch-08-data-modeling-normalization.md)、[Ch 9 系統規格與 SRS](./ch-10-spec-documents.md)、[Ch 18 DDD 戰術設計](../part-04-architecture/ch-18-ddd-strategic-tactical.md)
> **延伸補章**:無
