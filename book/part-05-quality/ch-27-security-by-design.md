...
> **下游章節**:[Ch 29 可靠性](./ch-30-sre-slo-chaos.md)、[Ch 30 可觀測性](./ch-29-observability-otel.md)、[Ch 36 AI-Native 架構](../part-07-ai-era/ch-37-ai-native-architecture.md)
...
- **下一章**:[Ch 29 可靠性](./ch-30-sre-slo-chaos.md) ⸺ DoS 緩解與 SLO 的接續;[Ch 30 可觀測性](./ch-29-observability-otel.md) ⸺ audit log 與 anomaly detection 的訊號設計
- **AI 時代延伸**:[Ch 36 AI-Native 架構](../part-07-ai-era/ch-37-ai-native-architecture.md) ⸺ Agent 工具呼叫鏈的安全邊界
