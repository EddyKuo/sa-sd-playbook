...
> **下游章節**:[Ch 29 可靠性](./ch-30-sre-slo-chaos.md)、[Ch 30 可觀測性](./ch-29-observability-otel.md)、[Ch 36 AI-Native 架構](../part-07-ai-era/ch-36-ai-native-architecture.md)
...
- **AI 時代延伸**:[Ch 36 AI-Native 架構](../part-07-ai-era/ch-36-ai-native-architecture.md) ⸺ Agent 工具呼叫鏈的安全邊界
