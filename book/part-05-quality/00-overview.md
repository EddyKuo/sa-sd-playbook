...
- **長距離影響**:[Ch 37 AI-Native 架構](../part-07-ai-era/ch-37-ai-native-architecture.md)(Ch 27 的安全設計原則在 AI 系統中擴大為 Human-in-the-loop 設計)、[Ch 45 AI Eval](../part-07-ai-era/ch-45-ai-eval-drift-redteam.md)(Ch 30 的 Chaos Engineering 思維延伸到 AI 系統的對抗性測試)
