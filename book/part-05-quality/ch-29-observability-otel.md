...
> **下游章節**:[Ch 30 SRE 與 SLO](./ch-30-sre-slo-chaos.md)、[Ch 33 ADR](../part-06-engineering/ch-33-adr-architecture-knowledge.md)、[Ch 39 Multi-Agent 系統設計](../part-07-ai-era/ch-39-multi-agent.md)
> **延伸補章**:無
...
- **AI Agent 觀測**:[Ch 39 Multi-Agent 系統設計](../part-07-ai-era/ch-39-multi-agent.md) ⸺ LLM trace 接到同一個 OTel 平面
