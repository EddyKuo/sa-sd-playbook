...
#### Ch 18｜Event Storming 與 Event Modeling
...
#### Ch 22｜事件驅動架構、CQRS 與 Event Sourcing
...
#### Ch 24｜Service Mesh、API Gateway、Cell-Based
...
#### Ch 27｜SRE、SLO、Chaos Engineering
...
#### Ch 34｜Context-Driven Engineering（CDE）
...
#### Ch 37｜AI Coding Agent / Pair Programming
...
#### Ch 38｜AI 系統的 Eval、Drift 與 Red Team
...
> [篇導讀 →](book/part-09-human-engineer/00-overview.md) 五章 + 補章 G / AI 使用框架到直覺保護 / 各讀者入口
